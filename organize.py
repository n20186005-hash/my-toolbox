...
# --- 3. 图标备份库 (Massively Expanded) ---
# 包含之前的图标以及根据 KEYWORD_CATEGORIES 扩充的新图标
BACKUP_ICONS = {
    # Electronics
